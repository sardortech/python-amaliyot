# -*- coding: utf-8 -*-
"""
Created on Sun Oct 30 00:48:58 2022
...
#   return toliq_ism #toliq qiymat qaytarish uchn return operatorini ishlatamiz
...
#Ixtiyoriy argument
# def toliq_ism_yasa(ism, familiya, otasining_ismi='Jorali'):
...
# avtolar = [avto1,avto2]
# print("Onlayn bozoridagi mavjud avtomashinalar:")
# for avto in avtolar:
#   if avto['narx']:
#     narx = avto['narx']
#   else:
...
#   else:
#     narx="Noma'lum"
#    print(f"{avto['rang'].title()} {avto['model']}.title(), {korobka['korobka'].title()}. Narxi: {narx}")
